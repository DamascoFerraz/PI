...
<head>
    ...
    <?php
        ...
        // checar se o usuario esta logado mas nao tem permissao de acesso por nao ter cargo de coordenador ou administrador
        if ($_SESSION['user']['position'] != "coordenador" and $_SESSION['user']['position'] != "administrador") {
