...
<body>
    ...
    <main>
        ...
        <section class="content contact">
            <br>
            <hgroup>
                <h1>Faça parte do Nucleo de estudos NEABI!</h1>
                <p>entre em contato pelos seguintes meios:</p>
                <br>
                <div>
                    <ul class="contacts-list">
                        <p><i class="fa-solid fa-envelope"></i> Email: NEABI@email.com</p>
                        <p><i class="fa-brands fa-square-whatsapp"></i> Whatsapp (contato): (xx) xx xxxxx-xxxx</p>
                        <p><i class="fa-solid fa-user-team"></i> Whatsapp (grupo): wa.me.teamierugierg</p>
                        <p><i class="fa-solid fa-location-dot"></i> Local: R rua N numero C cidade E estado</p>
                    </ul>
                </div>
            </hgroup>
        </section>
